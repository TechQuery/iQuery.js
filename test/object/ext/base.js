...
describe('object/ext/base.js', function() {
    ...
    describe('$.likeArray', function() {
        ...
        it('字符串元素不可变，故不是类数组', () => page.evaluate(() => {

            return $.likeArray(new String(''));

        }).should.be.fulfilledWith(false));

        it('有 length 属性、但没有对应数量元素的，不是类数组', () => page.evaluate(() => {
        ...
        it('NodeList、HTMLCollection、jQuery 等是类数组', () => page.evaluate(() => {

            return $.likeArray(document.head.childNodes);

        }).should.be.fulfilledWith(true));

        it('Node 及其子类不是类数组', () => page.evaluate(() => {
    ...
    describe('$.isEqual', function() {
        ...
        it('基本类型比较', () => page.evaluate(() => {

            return $.isEqual(1, 1);

        }).should.be.fulfilledWith(true));

        it('引用类型（浅）', () => page.evaluate(() => {
